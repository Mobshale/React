...
class Polls extends React.Component {
  ...
  submit = (context) => {
    ...
    if (
      ...
      this.state.ans !== null &&
      this.state.polltype != null
    ) {
      const PollRef = ref(FirebaseDatabase, time + "/poll/" + roomN + "/pes");
      const resultRef = ref(
        FirebaseDatabase,
        time + "/poll/" + roomN + "/hits"
      );
      ...
      <MContext.Consumer>
        {(context) => (
          <div>
            ...
            <br />
            <div class="sec">
              <Button type={this.state.poll1type} onClick={() => this.btn6()}>
                Yes/No
              </Button>
              <Button type={this.state.poll2type} onClick={() => this.btn7()}>
                A/B
              </Button>
              <Button type={this.state.poll3type} onClick={() => this.btn8()}>
                A/B/C/D
              </Button>
            </div>
            <br />
            <div class="sec">
              <Button type={this.state.optionA} onClick={() => this.btn9()}>
                A
              </Button>
              <Button type={this.state.optionB} onClick={() => this.btn10()}>
                B
              </Button>
              <Button
                type={this.state.optionC}
