...
const startClass = () => {
    ...
    if(sessionName){
        props.history.push("/guru/"+sessionName+"/"+ user.displayName.trim() + "/cdox/sdoc");
    ...
    return(
      <div class="-body">
        ...
        <div class="pricing-tabs"  >
            <div  class="pricing-card-free" id="pricing-tabs-free"  onClick={() => {
            document.getElementById("pricing-tabs-free").style.border = "3px solid #1890FF";
            document.getElementById("pricing-tabs-standard").style.border = "";
            ...
            <div  class="pricing-card-free" id="pricing-tabs-standard" onClick={() => {
            document.getElementById("pricing-tabs-free").style.border = "";
            document.getElementById("pricing-tabs-standard").style.border = "3px solid #1890FF";
            document.getElementById("pricing-tabs-premium").style.border = "";
            ...
            <div  class="pricing-card-free"  id="pricing-tabs-premium" onClick={() => {
            document.getElementById("pricing-tabs-free").style.border = "";
            document.getElementById("pricing-tabs-standard").style.border = "";
            document.getElementById("pricing-tabs-premium").style.border = "3px solid #1890FF";
       ...
       <Button onClick={() => startClass()} type="primary" block size="large" class="btn-start-class">
            Start Class
        </Button>
            ...
            <Avatar shape="square" size="large" src={photoURL} referrerpolicy="no-referrer" />                 
